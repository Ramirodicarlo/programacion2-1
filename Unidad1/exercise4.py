...
# COMPLETAR - INICIO
numero_entero_binario = int(numero_binario, 2)
numero_entero_octal = int(numero_octal, 8)
numero_entero_hexadecimal = int(numero_hexadecimal, 16)

multiplicacion_de_numeros = numero_entero_binario * numero_entero_octal * numero_entero_hexadecimal
# COMPLETAR - FIN
